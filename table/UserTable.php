...
class UserTable extends Table
{
	...
	{
		$sql = "select u.id,u.username,u.head_pic,u.sex,t.uid,t.follow,t.fans,t.likenum,t.tweet,t.thread,t.pinxiu,t.goods,t.newfans,t.newmsg,t.newat from tb_user u "
	...
	public function getUserByIds($idArr)
	{
		...
		$data   = array();
		if (count($idArr) && '' != $ids){
			$fieldsUser = "id,username,head_pic,email,sex";
        	$list  	= $this->listAllWithFields($fieldsUser,"id in (".$ids.")" , 'id desc');
